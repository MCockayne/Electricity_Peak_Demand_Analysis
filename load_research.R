# Load Historical_Simulation_Data.csv dataset into R
# download and install the scatterplot3d package from 
...
s3d <-scatterplot3d(max_temp,min_temp, peak_demand, pch=16, type="h")